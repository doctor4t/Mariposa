package dev.doctor4t.redwood.world.gen;
...
public class RedwoodSurfaceRuleData {
    ...
    public static MaterialRules.MaterialRule makeRules() {
        ...
        return MaterialRules.sequence(
                MaterialRules.condition(STONE_DEPTH_FLOOR_DOWN_1_WITH_DEPTH,
                        MaterialRules.condition(MaterialRules.biome(RedwoodBiomes.REDWOOD_FOREST),
                ...
                MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR,
                        MaterialRules.condition(MaterialRules.water(0, 0),
                                MaterialRules.condition(MaterialRules.biome(RedwoodBiomes.REDWOOD_FOREST), MaterialRules.sequence(
                                        MaterialRules.condition(surfaceNoiseThreshold (-.95), PODZOL),
                                        GRASS_BLOCK
                                )))),
                MaterialRules.condition(STONE_DEPTH_FLOOR_DOWN_1_WITH_DEPTH, MaterialRules.condition(MaterialRules.biome(RedwoodBiomes.REDWOOD_FOREST), DIRT))
        );
    }
