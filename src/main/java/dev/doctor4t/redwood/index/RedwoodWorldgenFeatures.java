...
import dev.doctor4t.redwood.world.gen.feature.GiantSequoiaLogFeature;
import dev.doctor4t.redwood.world.gen.feature.GiantSequoiaTreeFeature;
import dev.doctor4t.redwood.world.gen.feature.config.GiantSequoiaLogFeatureConfig;
import dev.doctor4t.redwood.world.gen.feature.config.GiantSequoiaTreeFeatureConfig;
...
public interface RedwoodWorldgenFeatures {
    ...
    static Feature<? extends FeatureConfig> create(String name, Feature<? extends FeatureConfig> feature) {
        FEATURES.put(feature, Redwood.id(name));
        return feature;
    }
