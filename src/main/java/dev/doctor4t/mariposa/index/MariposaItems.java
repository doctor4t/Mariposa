...
public interface MariposaItems {
    ...
    static void initialize() {
		...
		ItemGroupEvents.modifyEntriesEvent(ItemGroups.TOOLS).register(MariposaItems::addToolsEntries);
    }

    private static void addBuildingEntries(FabricItemGroupEntries entries) {
    ...
    private static void addNaturalEntries(FabricItemGroupEntries entries) {
        entries.addAfter(Blocks.CHERRY_LOG, MariposaBlocks.SEQUOIA_LOG);
        entries.addAfter(Blocks.CHERRY_LEAVES, MariposaBlocks.SEQUOIA_LEAVES);
        entries.addAfter(Blocks.CHERRY_SAPLING, MariposaBlocks.SEQUOIA_SAPLING);
    }
	...
	private static void addToolsEntries(FabricItemGroupEntries entries) {
		entries.addAfter(Items.CHERRY_CHEST_BOAT, SEQUOIA_BOAT, SEQUOIA_CHEST_BOAT);
	}
}
