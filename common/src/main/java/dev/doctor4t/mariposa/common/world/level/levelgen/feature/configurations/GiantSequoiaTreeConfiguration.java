...
public record GiantSequoiaTreeConfiguration(List<Identifier> sequoiaStructures, int minCornersInFloor) implements FeatureConfiguration {
	public static final Codec<GiantSequoiaTreeConfiguration> CODEC = RecordCodecBuilder.create(instance -> instance.group(
